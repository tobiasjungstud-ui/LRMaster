...
- **Nur Lizenzen, die Drucken und Verteilen im Unterricht erlauben**: Pexels-Lizenz, CC0, Public Domain, CC BY / CC BY-SA. Alles mit „NC" (nicht kommerziell) oder „ND" (keine Bearbeitung) bleibt draussen – ein Arbeitsblatt beschneidet und rastert das Bild.
...
- **Konzept-Manifest** (`app/manifest.js`): 317 Anforderungen aus dem Konzeptdokument und den Auftragserweiterungen (§33 Word-Export, §34 Schwierigkeitsmesser & Niveau der Fragen, §35 Pre-Task, §36 Post-Task, §37 Authentisches Layout, §38 Vorlagen), jede mit Prüfart:
