...
- **Suchbegriff aus dem Text.** Claude liefert im Layout-Schritt zusätzlich `photoQuery`: vier bis acht englische Wörter aus dem, was der generierte Text beschreibt (Ort, Szene, Menschen, Handlung), passend zur Bildsprache des Mediums – Nachrichtenfoto für die Zeitung, Ortsaufnahme für Reisen, Porträt im Umfeld für ein Profil. Ohne Claude entsteht der Suchbegriff aus Bildlegende und Schlagzeile des generierten Textes, nie aus den Einstellungen.
- **Quelle.** Die Seite fragt direkt aus dem Browser offene Bildsammlungen ab, die das erlauben (CORS, ohne Schlüssel): zuerst **Wikimedia Commons**, dann mit kürzerem Begriff noch einmal, dann **Openverse**. Google Bilder ist für eine Seite nicht erreichbar und wird nicht vorgetäuscht.
- **Auswahl.** Nur Fotos (JPEG/PNG/WebP), keine Logos, Karten, Diagramme oder Scans; die Form passt zum Bildplatz (quer für einen Aufmacher), mindestens 640 × 360 px; nur freie Lizenzen (CC0, Public Domain, CC BY, CC BY-SA, für den eigenen Unterricht auch CC BY-NC), **nie ND**. Gereiht wird nach Übereinstimmung mit dem Text, nicht nach einem einzelnen Stichwort.
- **Nur was wirklich da ist.** Ein Foto zählt erst, wenn es heruntergeladen ist und sich als Bild öffnen lässt. Es wird genau wie ein eigenes Bild der Lehrperson in den Platz des Aufmacherbildes gesetzt (Bildspeicher der Seite, sonst verkleinert im Material) – deshalb zeigen Vorschau, Blatt, Viewer, Word und PNG **dasselbe Foto**, randlos zugeschnitten statt verzerrt. Der Nachweis („Foto: Autor / Wikimedia Commons, CC BY-SA 4.0“) steht in der Lehrerversion, die Quelle ist am Bild gespeichert.
- **Nie ein Hindernis.** Kein Netz, eine blockierte Quelle, kein Treffer, kein Bild, zu langsam (höchstens 15 Sekunden), Abbrechen: in jedem Fall entsteht das Material wie bisher, mit dem gezeichneten Bild – kein kaputtes Bild, kein erfundener Treffer. Der Layout-Tab sagt in einem Satz, ob ein echtes Foto gefunden wurde. Jedes Bild lässt sich weiterhin von Hand ersetzen.
