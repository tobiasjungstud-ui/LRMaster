...
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./core.js'), require('./prompts.js'), require('./quality.js'), require('./render.js'), require('./vocab.js'), require('./manifest.js'), require('./fixture.js'));
  } else {
    root.LR = root.LR || {};
    root.LR.checks = factory(root.LR.core, root.LR.prompts, root.LR.quality, root.LR.render, root.LR.vocab, root.LR.manifest, root.LR.fixture);
  }
})(typeof self !== 'undefined' ? self : this, function (core, prompts, quality, render, vocab, manifest, fixture) {
  'use strict';
  ...
  function makeEnv(opts) {
    ...
    const env = {
      core, prompts, quality, render, vocab, textbooks, ctx,
