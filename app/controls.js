...
(function (root, factory) {
  ...
  const RANGE_ENDS = {
    ...
    idiomaticLanguage: ['Few', 'Many (for the level)'],
  ...
  const HELP = {
    ...
    vocabularyDifficulty: 'Welche Wörter vorkommen, ist frei – auch weit über die Unit hinaus; das Zielvokabular muss einfach drin sein. Der Regler bestimmt nur, WIE GEBRÄUCHLICH die Wörter sind, immer innerhalb des CEFR-Niveaus des Textes: 0 = nur sehr häufige Wörter (leichtes Ende des Niveaus), 100 = seltenere Wörter (anspruchsvolles Ende), nie über das Niveau hinaus. Claude bekommt dafür einen messbaren Zielbereich, der Qualitätsbericht zeigt, ob der Text dort liegt. Das Fragen-Niveau A/B steuert nur die Fragen, nicht den Text.',
    grammarComplexity: 'Wie komplex die Sätze gebaut sind (Nebensätze, Passiv, Perfekt, Konditionalsätze, Vergleiche) – innerhalb des CEFR-Niveaus des Textes: 0 = einfachste Strukturen dieses Niveaus, 100 = sein volles Repertoire, nie darüber.',
    idiomaticLanguage: 'Wie viele Redewendungen und Phrasal Verbs – im Rahmen dessen, was das CEFR-Niveau des Textes erlaubt.',
